...
private struct CropBodyView: UIViewControllerRepresentable {
    ...
    fileprivate func updateUIViewController(_ uiViewController: UIViewControllerType, context: Context) {
        // NOP
    }
    ...
    fileprivate class Coordinator: NSObject, CropViewControllerDelegate {
        ...
        fileprivate func cropViewController(_ cropViewController: CropViewController, didCropToImage image: UIImage, withRect cropRect: CGRect, angle: Int) {
            parent.completion(image)
            cropViewController.dismiss(animated: true)
        }
        
        fileprivate func cropViewController(_ cropViewController: CropViewController, didFinishCancelled cancelled: Bool) {
